...
[@nemesis-oss/coindcx-sdk API Reference](../index.md) / CoinDCXRateLimitError

# Class: CoinDCXRateLimitError

Defined in: [core/errors.ts:42](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L42)
...
> **new CoinDCXRateLimitError**(`message`, `status`, `data`, `method`, `url`, `retryAfter`): `CoinDCXRateLimitError`

Defined in: [core/errors.ts:45](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L45)
...
Defined in: [core/errors.ts:43](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L43)
