...
[@nemesis-oss/coindcx-sdk API Reference](../index.md) / CoinDCXInsufficientMarginError

# Class: CoinDCXInsufficientMarginError

Defined in: [core/errors.ts:69](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L69)
...
> **new CoinDCXInsufficientMarginError**(`message`, `status`, `data`, `method`, `url`): `CoinDCXInsufficientMarginError`

Defined in: [core/errors.ts:70](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L70)
