...
[@nemesis-oss/coindcx-sdk API Reference](../index.md) / CoinDCXOrderError

# Class: CoinDCXOrderError

Defined in: [core/errors.ts:85](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L85)
...
> **new CoinDCXOrderError**(`message`, `status`, `data`, `method`, `url`): `CoinDCXOrderError`

Defined in: [core/errors.ts:86](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L86)
