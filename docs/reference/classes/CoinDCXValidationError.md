...
[@nemesis-oss/coindcx-sdk API Reference](../index.md) / CoinDCXValidationError

# Class: CoinDCXValidationError

Defined in: [core/errors.ts:61](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L61)
...
> **new CoinDCXValidationError**(`message`, `status`, `data`, `method`, `url`): `CoinDCXValidationError`

Defined in: [core/errors.ts:62](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L62)
