...
[@nemesis-oss/coindcx-sdk API Reference](../index.md) / CoinDCXAuthenticationError

# Class: CoinDCXAuthenticationError

Defined in: [core/errors.ts:53](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L53)
...
> **new CoinDCXAuthenticationError**(`message`, `status`, `data`, `method`, `url`): `CoinDCXAuthenticationError`

Defined in: [core/errors.ts:54](https://github.com/shubhamtaywade82/coindcx-sdk/blob/ed817fac7b96aa51708606280e2193d6f691e34f/src/core/errors.ts#L54)
